...
import img from '../images/courses.png';
import img2 from '../images/podcast.png';
import img3 from '../images/articles.png';
import img4 from '../images/jobs.png';
        ...
        <div id="services" className="bg-gray-100 py-12" >
            <section data-aos="zoom-in-down">
                <div className="my-4 py-4">
                    <h2 className="my-2 text-center text-3xl text-blue-900 uppercase font-bold">Catalogue</h2>
